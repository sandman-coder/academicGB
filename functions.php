<?php
/**
 * academicGB functions and definitions
 *
...
if ( ! function_exists( 'academic_setup' ) ) :
	...
	function academic_setup() {
		 ...
		 * If you're building a theme based on academicGB, use a find and replace
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'academic' ),
		) );
...
function academic_scripts() {
	...
	wp_enqueue_style('academic-layout' , get_template_directory_uri() .
	'/layouts/styles/layout.css');
